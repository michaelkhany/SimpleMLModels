...
class EnergyEfficiencyNN(nn.Module):
    def __init__(self):
        super(EnergyEfficiencyNN, self).__init__()
        self.fc1 = nn.Linear(10, 5)  # Assuming 10 features
...
# Save the model
model_save_path = "EnergyEfficiencyModel/energy_efficiency_nn_model.pth"
...
# Load the model
model_load_path = "EnergyEfficiencyModel/energy_efficiency_nn_model.pth"
loaded_model = EnergyEfficiencyNN()
