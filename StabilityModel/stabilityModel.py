...
class StabilityNN(nn.Module):
    def __init__(self):
        super(StabilityNN, self).__init__()
...
# Save the model
model_save_path = "StabilityModel/stability_nn_model.pth"
...
# Load the model
model_load_path = "StabilityModel/stability_nn_model.pth"
loaded_model = StabilityNN()
